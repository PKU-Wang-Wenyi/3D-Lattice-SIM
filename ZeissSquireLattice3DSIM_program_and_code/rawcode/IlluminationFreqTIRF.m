...
% Zmask = ((Rp<0.1*obj.Kotf ));%.*(1-(Rm<0.04*obj.Kotf )); % revised
Zmask = ((Rp<0.05*obj.Kotf ));%.*(1-(Rm<0.04*obj.Kotf )); % revised
k2fa = peakCCidx(obj,fAo0,fAp0,Zmask);
t = 2*obj.w;
fAo_temp = gpuArray.zeros(t,t,'single');
fAp_temp = gpuArray.zeros(t,t,'single');
