...
if size(obj.fSnoisy,3)<13
    ...
    % Zmask1 = (obj.Ro>0.2*obj.Kotf ).*(obj.Ro<=0.5*obj.Kotf );
    % Zmask2 = (obj.Ro>0.5*obj.Kotf ).*(obj.Ro<=0.7*obj.Kotf );
    % Zmask3 = (obj.Ro>0.7*obj.Kotf ).*(obj.Ro<1.2*obj.Kotf );
    Zmask1 = (obj.Ro>0.1*obj.Kotf ).*(obj.Ro<=0.5*obj.Kotf );
    Zmask2 = (obj.Ro>0.3*obj.Kotf ).*(obj.Ro<=0.7*obj.Kotf );
    Zmask3 = (obj.Ro>0.5*obj.Kotf ).*(obj.Ro<1.2*obj.Kotf );
    ...
    kAo(2,:) = peakCCidx(obj,Separated_temp(:,:,1),Separated_temp(:,:,4),Zmask3);
    kAo(3,:) = peakCCidx(obj,Separated_temp(:,:,1),Separated_temp(:,:,6),Zmask3);
    kAo(4,:) = peakCCidx(obj,Separated_temp(:,:,1),Separated_temp(:,:,8),Zmask2);
    kAo(5,:) = peakCCidx(obj,Separated_temp(:,:,1),Separated_temp(:,:,10),Zmask1);
